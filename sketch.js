...
function setup() {
	...
	boxSide1=createSprite(packageBody.position.x, 650,200,20);
	boxSide1.shapeColor="red";
	boxSide1.depth=packageSprite.depth-1;

	boxSide2=createSprite(300, 600,20,100);
	boxSide2.shapeColor="red";

	boxSide3=createSprite(500, 600,20,100);
